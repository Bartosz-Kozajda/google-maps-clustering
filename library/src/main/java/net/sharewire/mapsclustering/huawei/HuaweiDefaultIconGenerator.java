 ...
 */
public class HuaweiDefaultIconGenerator<T extends ClusterItem> implements HuaweiIconGenerator<T> {
     ...
     */
    public HuaweiDefaultIconGenerator(@NonNull Context context) {
