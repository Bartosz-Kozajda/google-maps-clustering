...
class HuaweiClusterRenderer<T extends ClusterItem> implements HuaweiMap.OnMarkerClickListener {
    ...
    HuaweiClusterRenderer(@NonNull Context context, @NonNull HuaweiMap HuaweiMap) {
        mHuaweiMap = HuaweiMap;
        mHuaweiMap.setOnMarkerClickListener(this);
        mIconGenerator = new HuaweiDefaultIconGenerator<>(context);
    }
    ...
    void setCallbacks(@Nullable HuaweiClusterManager.Callbacks<T> listener) {
        mCallbacks = listener;
    }

    void setIconGenerator(@NonNull HuaweiIconGenerator<T> iconGenerator) {
